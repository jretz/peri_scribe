...
DIFFERENTIAL_PERIMETER_COLUMNS = [
    *peri_scribe.fire_history.IDENTITY_COLUMNS,
    "source",
    "source_subsource",
    "source_objectid",
    "source_globalid",
...
def fire_positions(frame: geopandas.GeoDataFrame) -> list[list[int]]:
    ...
    current: list[int] = []
    identity_columns = peri_scribe.fire_history.IDENTITY_COLUMNS
...
def differential_perimeter_dataframe(
    ...
    return peri_scribe.fire_history.build_dataframe(
        rows,
        DIFFERENTIAL_PERIMETER_COLUMNS,
    )
    ...
    peri_scribe.output.write_geopackage(
        ...
        [
            peri_scribe.models.LayerData(
                name=peri_scribe.fire_history.PERIMETER_LAYER_NAME,
                dataframe=differential_perimeter_dataframe(full_perimeters),
            ),
            peri_scribe.models.LayerData(
                name=peri_scribe.fire_history.POINT_LAYER_NAME,
