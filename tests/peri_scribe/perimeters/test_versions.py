...
import tests.peri_scribe.perimeters.versions_helpers


@hypothesis.given(
    states=tests.peri_scribe.perimeters.versions_helpers.attribute_histories(),
...
def test_point_versions_matches_runs_of_attribute_states(
    ...
    observations = tests.peri_scribe.perimeters.versions_helpers.point_observations(
        states,
    )
    expected = []
...
def test_collapse_identical_consecutive_perimeters_matches_runs_of_shapes(
    ...
    observations = tests.peri_scribe.perimeters.versions_helpers.perimeter_observations(
        shapes,
    )
    expected = []
