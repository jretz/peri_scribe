...
import tests.peri_scribe.fires.files_helpers
...
def test_write_history_of_full_geography_reuses_unchanged_fires(
    ...
    unexpected = tests.peri_scribe.fires.files_helpers.reject_history_reconstruction
    ...
    tests.peri_scribe.fires.files_helpers.assert_histories_equal(first, second)
...
def test_write_history_of_full_geography_rebuilds_only_affected_fires(
    ...
    tracked = tests.peri_scribe.fires.files_helpers.make_history_recorder(
        calls=calls,
        derive=derive,
    )
