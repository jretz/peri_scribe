"""Build streamed centroid inputs independently from the centroid arithmetic."""
...
def centroids(
    ...
    """
    features = tests.peri_scribe.fires.centroid_streaming_helpers.geometry_features([
