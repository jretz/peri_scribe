"""Tests for peri_scribe.fire_history."""
...
def test_perimeter_row_builds_fields_and_geometry() -> None:
    ...
    row = peri_scribe.fire_history.perimeter_row(tests.factories.fire(), None, version)
...
def test_point_row_builds_fields_and_geometry() -> None:
    ...
    row = peri_scribe.fire_history.point_row(tests.factories.fire(), None, version)
    assert row["geometry"] == geometry
