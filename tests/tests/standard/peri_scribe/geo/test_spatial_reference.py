...
import tests.helpers.factories.peri_scribe.geo.spatial_reference
...
def test_coordinates_in_area_inside_california_albers() -> None:
    ...
    assert peri_scribe.geo.spatial_reference.coordinates_in_area(
        crs,
        tests.helpers.factories.peri_scribe.geo.spatial_reference.CALIFORNIA_BOUNDS,
    )
...
def test_choose_spatial_reference_id_uses_query_spatial_reference() -> None:
    ...
    bounds = tests.helpers.factories.peri_scribe.geo.spatial_reference.CALIFORNIA_BOUNDS
...
def test_select_spatial_reference_wkid_single_out_of_area_candidate_is_chosen() -> None:
    selection = peri_scribe.geo.spatial_reference.select_spatial_reference_wkid(
        {tests.helpers.factories.geography.NAD83_WKID},
        tests.helpers.factories.peri_scribe.geo.spatial_reference.OUTSIDE_NAD83_AREA_BOUNDS,
    )
