...
def test_read_geopackage_omits_rows_without_status(
    ...
    tests.helpers.doubles.peri_scribe.geo.package.stub_single_layer(
        stub_geo_package,
        "Fires_One_0",
        "Polygon",
        tests.helpers.factories.peri_scribe.geo.package.wgs84_dataframe({
            "incident_name": ["Park Fire", "ALTA"],
...
def test_read_geopackage_cached_round_trips_memberships(
    ...
    dataframe = tests.helpers.factories.peri_scribe.geo.package.wgs84_dataframe({
        "IncidentName": ["0445 CROSSWHITE", "ROWE CREEK COMPLEX"],
        "ActiveFireCandidate": [1, 1],
        "IrwinID": [
            "{1B0219EE-5298-4FEF-9927-C2666D9D53FC}",
