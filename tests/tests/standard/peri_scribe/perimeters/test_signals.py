...
def test_geometry_signal_inside_california(
    ...
    result = peri_scribe.perimeters.signals.geometry_signal(
        ...
        boundaries,
        tests.helpers.factories.peri_scribe.perimeters.signals.PLANAR_CONFIG,
    )
...
def test_freshest_observation_prefers_later_observation_time() -> None:
    earlier = tests.helpers.factories.peri_scribe.perimeters.signals.observation(
    ...
    later = tests.helpers.factories.peri_scribe.perimeters.signals.observation(
        tests.helpers.factories.peri_scribe.perimeters.signals.FIRIS,
        shapely.geometry.Point(-120.0, 39.0),
...
def test_freshest_observation_breaks_time_ties_by_serial_number() -> None:
    older_snapshot = tests.helpers.factories.peri_scribe.perimeters.signals.observation(
        tests.helpers.factories.peri_scribe.perimeters.signals.WFIGS_PERIMETER,
        shapely.geometry.Point(-120.0, 39.0),
        observed_at=datetime.datetime(2026, 8, 13, tzinfo=datetime.UTC),
        serial_number=1,
    )
    newer_snapshot = tests.helpers.factories.peri_scribe.perimeters.signals.observation(
        tests.helpers.factories.peri_scribe.perimeters.signals.WFIGS_PERIMETER,
        shapely.geometry.Point(-120.0, 39.0),
        observed_at=datetime.datetime(2026, 8, 13, tzinfo=datetime.UTC),
        serial_number=2,
...
def test_freshest_observation_treats_missing_time_as_oldest() -> None:
    untimed = tests.helpers.factories.peri_scribe.perimeters.signals.observation(
        tests.helpers.factories.peri_scribe.perimeters.signals.FIRIS,
        shapely.geometry.Point(-120.0, 39.0),
    )
    timed = tests.helpers.factories.peri_scribe.perimeters.signals.observation(
        tests.helpers.factories.peri_scribe.perimeters.signals.FIRIS,
        shapely.geometry.Point(-120.0, 39.0),
        observed_at=datetime.datetime(2026, 8, 13, tzinfo=datetime.UTC),
    )
...
def test_are_contemporaneous_true_when_both_times_missing() -> None:
    left = tests.helpers.factories.peri_scribe.perimeters.signals.observation(
        tests.helpers.factories.peri_scribe.perimeters.signals.FIRIS,
        shapely.geometry.Point(-120.0, 39.0),
    )
    right = tests.helpers.factories.peri_scribe.perimeters.signals.observation(
        tests.helpers.factories.peri_scribe.perimeters.signals.WFIGS_PERIMETER,
        shapely.geometry.Point(-120.0, 39.0),
    )
...
def test_extent_signal_skips_non_contemporaneous_perimeters() -> None:
    firis = tests.helpers.factories.peri_scribe.perimeters.signals.observation(
        tests.helpers.factories.peri_scribe.perimeters.signals.FIRIS,
        shapely.geometry.box(-120.5, 39.0, -120.0, 39.1),
        observed_at=datetime.datetime(2026, 8, 13, tzinfo=datetime.UTC),
    )
    wfigs = tests.helpers.factories.peri_scribe.perimeters.signals.observation(
        tests.helpers.factories.peri_scribe.perimeters.signals.WFIGS_PERIMETER,
...
def test_extent_signal_disagrees_when_wfigs_is_larger() -> None:
    ...
    assert (
        result.wfigs_to_firis_area_ratio
        > (
            tests.helpers.factories.peri_scribe.perimeters.signals.CONFIG
        ).extent_ratio_threshold
    )
