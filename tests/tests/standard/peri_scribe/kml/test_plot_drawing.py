...
import tests.helpers.factories.peri_scribe.kml.plot_drawing
import tests.helpers.factories.peri_scribe.kml.plot_histories
import tests.helpers.peri_scribe.kml.plot_drawing
...
def test_draw_plot_gives_small_ticks_distinct_accurate_labels(peak: float) -> None:
    series = peri_scribe.kml.plot_data.PlotSeries(
        label="Cost to date",
        points=(
            tests.helpers.factories.peri_scribe.kml.plot_histories.series_point(1, 0.0),
...
def test_x_axis_ticks_uses_each_midnight_when_days_fit() -> None:
    ...
    assert peri_scribe.kml.plot_drawing.x_axis_ticks(series) == (
        ...
        tests.helpers.factories.peri_scribe.kml.plot_histories.observation_time(3),
    )
...
def test_x_axis_ticks_thins_when_days_do_not_fit() -> None:
    ...
    assert peri_scribe.kml.plot_drawing.x_axis_ticks(series) == (
        tests.helpers.factories.peri_scribe.kml.plot_histories.observation_time(1),
        tests.helpers.factories.peri_scribe.kml.plot_histories.observation_time(5),
        tests.helpers.factories.peri_scribe.kml.plot_histories.observation_time(9),
        tests.helpers.factories.peri_scribe.kml.plot_histories.observation_time(13),
        tests.helpers.factories.peri_scribe.kml.plot_histories.observation_time(17),
    )
...
def test_x_axis_ticks_does_not_force_the_last_day() -> None:
    ...
    assert peri_scribe.kml.plot_drawing.x_axis_ticks(series) == (
        ...
        tests.helpers.factories.peri_scribe.kml.plot_histories.observation_time(3),
        tests.helpers.factories.peri_scribe.kml.plot_histories.observation_time(5),
        tests.helpers.factories.peri_scribe.kml.plot_histories.observation_time(7),
        tests.helpers.factories.peri_scribe.kml.plot_histories.observation_time(9),
    )
...
def test_draw_plot_returns_well_formed_svg_for_one_series() -> None:
    content = peri_scribe.kml.plot_drawing.draw_plot(
        tests.helpers.factories.peri_scribe.kml.plot_drawing.one_series_plot(),
...
def test_draw_plot_legend_identifies_visible_area_sources(
    ...
    legend = tests.helpers.peri_scribe.kml.plot_drawing.plot_legend(content)
...
def test_draw_plot_legend_omits_series_without_lines(
    ...
    points = tests.helpers.factories.peri_scribe.kml.plot_drawing.one_series_plot()[
        0
    ].points
    content = peri_scribe.kml.plot_drawing.draw_plot((
        peri_scribe.kml.plot_data.PlotSeries(
...
def test_draw_plot_legend_includes_zero_valued_personnel() -> None:
    ...
    legend = tests.helpers.peri_scribe.kml.plot_drawing.plot_legend(
        peri_scribe.kml.plot_drawing.draw_plot((series,)),
    )
...
def test_line_segments_keeps_source_switch_connected() -> None:
    first = tests.helpers.factories.peri_scribe.kml.plot_histories.series_point(1, 100)
    second = tests.helpers.factories.peri_scribe.kml.plot_histories.series_point(2, 100)
    report = dataclasses.replace(
        tests.helpers.factories.peri_scribe.kml.plot_histories.series_point(3, 150),
        reported=True,
    )
    mapped = tests.helpers.factories.peri_scribe.kml.plot_histories.series_point(4, 160)
