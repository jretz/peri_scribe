"""Generate point-store examples with constrained domains."""
...
def point_queries(
    ...
    """Place points and queries on a shared grid to exercise containment boundaries.
    ...
    Returns:
        Points and nearby geometries to query against the stored points.
    """
