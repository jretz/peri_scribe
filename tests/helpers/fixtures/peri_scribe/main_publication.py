"""Isolate main publication tests with explicit fixtures."""
...
def scenario(
...
) -> tests.helpers.peri_scribe.main_publication.Scenario:
    ...
    return tests.helpers.peri_scribe.main_publication.Scenario(
        year=year,
        stubs=stubs,
        indexed=indexed,
        inputs=inputs,
