...
The only tool required on a development system is a recent version of [`mise-en-place`](https://mise.jdx.dev/installing-mise.html). `mise` is used to manage isolated, project specific versions of all other tools used for development and testing.
